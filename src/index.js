...
/* terminal.addCommand(function github() {
  terminal.log([
    ...
    "https://github.com/bleb1k/Terminus.JS",
    "\nYou can find original here:",
    "https://github.com/rando-idiot/Terminus.JS"
  ].join("\n"));
});
  ...
  terminal.changeCommand(function infshop() {
    let list = game.upgstage === 1
      ? [ // todo: Export cost calculations
        `stepone: $${5 + game.upgpriceboost * game.upgpriceboost
        }\nIncreases step 1 addition`,
        `steptwo: $${25 + game.upgpriceboost * game.upgpriceboost
        }\nIncreases step 2 multiplier`,
        `stepthree: $${25 + game.upgpriceboost * game.upgpriceboost
        }\nIncreases step 3 multiplier`,
        `stepfour: $${2 + game.upgpriceboost * game.upgpriceboost
        }\nIncreases step 4 addition`,
      ]
      : [
        `stepone: $${20 + game.upgpriceboost * game.upgpriceboost
        }\nIncreases step 1 addition`,
        `steptwo: $${100 + game.upgpriceboost * game.upgpriceboost
        }\nIncreases step 2 multiplier`,
        `stepthree: $${100 + game.upgpriceboost * game.upgpriceboost
        }\nIncreases step 3 multiplier`,
        `stepfour: $${8 + game.upgpriceboost * game.upgpriceboost
        }\nIncreases step 4 addition`,
        `maxpowerup: $${800 + game.upgpriceboost * game.upgpriceboost
    ...
    list = [
      ...
      ...list,
      `baseup: $${500 + game.upgpriceboost * game.upgpriceboost
      }\nIncreases the base that is then multiplied etc etc`,
      `upgbonus: $${100 + game.upgpriceboost * game.upgpriceboost
